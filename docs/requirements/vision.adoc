...
[cols="1,3"]
|===
| Das Problem | Cocktails individuell zusammenstellen
| betrifft | Barbetreiber und Mitarbeiter
| die Auswirkung davon ist | Kunden können manche Cocktails nicht bekommen
| eine erfolgreiche Lösung wäre | Erarbeitung eines Systems was Kunden ermöglicht diese Cocktails zu erhalten
|===
...
|===
| Für | Barbesucher
| der / die | die besondere Wünsche haben und besser ihre Cocktails bestellen wollen
| Das Produkt / die Lösung ist ein | Onlineshop
| Die / Das | Der das bestellen von Cocktails simple gestaltet und dem Barbetreiber mehr Reichweite und Geld einbringt
| Im Gegensatz zu | Nur Cocktails die in der Bar auf der Karte stehen
| Unser Produkt | ist ein Onlineshop der das Angebot individuell anpasst für jeden Kunden
|===
...
| Barbetreiber
| Besitzer und Auftraggeber der Bar
| Ist der Ideenlieferer 

| Entwickler
| Entwickler des Onlineshops
| Ist für die Umsetzung der Aufgabe zuständig


| Projekt/Produktgegner
| Andere Onlineshops für Cocktails andere Anbieter
| Will besser sein als der Entworfene Onlineshop und ist Konkurrent
|===
