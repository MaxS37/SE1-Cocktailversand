...
| cocktail |  Mischgetränk aus alkoholischen und nicht alkoholischen Zutaten | Drink,Mische
| Topping  |  Garnierung von Speisen und Getränken mit festen oder flüssigen Lebensmitteln | extra
| Auftrag |  Weisung; zur Erledigung übertragene Aufgabe | 
|===
